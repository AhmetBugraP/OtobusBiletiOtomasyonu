...
namespace otobus_otomasyon
{
    public partial class admin : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=DESKTOP-97QTDM6; initial Catalog=otobus; Integrated Security=true");
        ...
        public void doldur()
        {
           ...
           //bazı gereksiz kısımları görünmez yapan kod "id şifre gibi."
            dataGridView1.MultiSelect = false;//birden fazla satır seçielemez yapar
